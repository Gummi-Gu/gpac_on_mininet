...
def setup_network():
    try:
        ...
        server.cmd('route add -net 192.168.16.0/16 gw 192.168.16.2 dev  server-eth1')
        ...
        client1.cmd('route add -net 192.168.16.0/16 gw 192.168.16.2 dev  client1-eth1')
        ...
        client2.cmd('route add -net 192.168.16.0/16 gw 192.168.16.2 dev  client2-eth1')
