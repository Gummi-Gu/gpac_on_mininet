...
TRAFFIC_CLASSES = {
    'high': {'mark': 10, 'rate': '45mbit', 'ceil': '45mbit', 'classid': '1:10'},
    'middle': {'mark': 20, 'rate': '25mbit', 'ceil': '25mbit', 'classid': '1:20'},
...
class TrafficControl:
    ...
    def setup_tc(server):
        cmds = [
            ...
            'tc class add dev server-eth0 parent 1: classid 1:1 htb rate 80mbit',
